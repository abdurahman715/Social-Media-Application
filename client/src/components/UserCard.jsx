    ...
    >
      ...
      <div className="flex mt-4 gap-2">
        ...
        <button
          ...
          className="w-full py-2 flex justify-center items-center gap-2 rounded-md bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer"
        >
        ...
        >
          {currentUser?.connections.includes(user._id) ? (
            <MessageCircle className="w-h h-5 group-hover:scale-105 transition" />
          ) : (
