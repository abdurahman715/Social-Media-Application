                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    ...
                    {currentTab === "Connections" && (
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-gradient-to-r bg-slate-100 hover:bg-slate-200 active:scale-95 transition text-black cursor-pointer flex items-center justify-center gap-1"
                      >
